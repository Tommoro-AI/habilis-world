...
2. **Selected Task name** 목록에서 변환을 원하는 Task name을 선택합니다.
![예시 이미지](../../public/page5/main.gif)
...
![예시 이미지](../../public/page5/tags.gif)
:::

## Step 2. 데이터 변환 실행
**[Convert]** 버튼을 클릭하여 LeRobot 형식으로 변환합니다.
상단의 Convert Status 섹션에서 실시간 변환 진행 상황을 모니터링할 수 있습니다.
**[Cancel]** 버튼을 클릭하여 변환을 중지할 수 있습니다.
![예시 이미지](../../public/page5/convert.gif)
